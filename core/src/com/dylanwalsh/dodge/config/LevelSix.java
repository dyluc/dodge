...
public class LevelSix extends LevelConfig {
    ...
    public LevelSix() {
        ...
        aliens.put("max_velocity", Gdx.graphics.getWidth()/5f);//change - faster
        ...
        alien.put("bullet_speed", 1.2f); //change - faster bullets
        ...
        background.put("stars_per_spawn", 3); //change - more stars
        ...
        debris.put("max_vel", Gdx.graphics.getWidth() / 6.5f); //change - faster
        debris.put("min_vel", Gdx.graphics.getWidth() / 8.5f);

        debrisItem.put("fade_interval", 0.16f);//change - quicker fade
        ...
        gammaRays.put("max_length", 30); //change - longer rays
