...
public class LevelTen extends LevelConfig {
    ...
    public LevelTen() {
        ...
        aliens.put("max_velocity", Gdx.graphics.getWidth()/4.5f); //change - faster
        ...
        alien.put("fire_rate", 1.7f); //change - faster fire
        ...
        gammaRays.put("max_length", 37); //change - larger rays
