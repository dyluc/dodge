...
public class LevelThirteen extends LevelConfig {
    ...
    public LevelThirteen() {
        ...
        aliens.put("max_velocity", Gdx.graphics.getWidth()/4.3f); //change - faster
        ...
        alien.put("bullet_size", Gdx.graphics.getWidth()/38f); //change - larger bullets
        ...
        background.put("min_star_size", Gdx.graphics.getWidth()/80f); //change - reduce range
        background.put("max_star_speed", Gdx.graphics.getWidth()/4f);
        background.put("min_star_speed", Gdx.graphics.getWidth()/6f);


        debris.put("spawn_rate", 0.6f);
        debris.put("spawn_delay", 2);//round wait
        debris.put("spawn_count", 15);
        debris.put("max_vel", Gdx.graphics.getWidth() / 5.8f); //change - faster
        ...
        gammaRays.put("max_amplitude", Gdx.graphics.getWidth()/65f); //change - larger amplitude
