...
public class LevelOne extends LevelConfig{
    ...
    public LevelOne() {
        ...
        aliens.put("max_velocity", Gdx.graphics.getWidth()/8f);
        ...
        background.put("stars_per_spawn", 1);
        ...
        debrisItem.put("fade_interval", 0.2f);
        debrisItem.put("fade_increment", 1/20f);
        debrisItem.put("spawn_delay", 2);

        gammaRays.put("speed", Gdx.graphics.getWidth()/8f);
